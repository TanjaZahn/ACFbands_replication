...
# File: Simulations for dynamic regressions with GARCH errors - Setup
...
path_results <- "results/sim_dyn_garch/"
...
type_vec <- c("pointwise", "sup-t")
names(type_vec) <- type_vec

# Types of covariance matrices
covar_vec <- c("classical", "robust")
names(covar_vec) <- covar_vec 

# Types of confidence bands
type_vec_robust <- c("bonferroni")
names(type_vec_robust) <- type_vec_robust

# Vector of tests
test_vec <- c("ljungbox_res", "BG")
