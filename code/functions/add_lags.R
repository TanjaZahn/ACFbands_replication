...
#'
#' @param df data frame
#' @param colname a character string specifying the name of the variable we want to lag.
#' @param lag_vec vector containing the lags that should be created, i.e. c(1, 4) lags the variable by 1 and by 4.
#'
#' @return the original data frame expanded by columns containing the lagged variable.
#' 
