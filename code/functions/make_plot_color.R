...
#'
#' @param df data frame
#' @param segment logical. Determines whether sample autocorrelations are plotted are vertically  (`TRUE`) or horizontally (`FALSE`). The former is used for significance bands, the latter for confidence bands.
#' @param line_vec a vector containing the linetypes of the different inference bands.
#' @param color_vec a vector containing the colors of the different inference bands.
#'
#' @return a plot
#' 
