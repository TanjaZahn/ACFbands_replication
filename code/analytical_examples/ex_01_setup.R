...
phi_vec <- setNames(c(0, 0.25, 0.5, 0.75, 0.95), c(0, 0.25, 0.5, 0.75, 0.95))
...
mylabels <- c(expression(paste(phi," = ", "0.0")),
              ...
              expression(paste(phi," = ", "0.95")))


greys <- gray.colors(5, start = 0.1, end = 0.7, gamma = 2.2, alpha = NULL, rev = FALSE)
mycolors <- greys

# Linetypes
mylines <- c("longdash" , "twodash", "dotted", "dotdash", "longdash")
