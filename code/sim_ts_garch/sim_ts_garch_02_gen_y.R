...
# File: Simulations for time series with GARCH errors - Draw the time series using an AR(1) process with GARCH errors.
...
lapply(1:nrow(params), function(p){ # iterate over parameters
  ...
  # Simulation
  y_r <- replicate(R_mc, sim_ar1_y_garch(N = N, I = I, phi = phi), simplify = "array")
