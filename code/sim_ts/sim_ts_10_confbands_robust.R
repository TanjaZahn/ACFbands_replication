...
# File: Simulations for time series - Construct robust confidence bands.
...
# Generate Bonferroni Confidence Bands: All bandwidths -------------------
...
# Generate all confidence Bands for one bandwidth ------------------------
