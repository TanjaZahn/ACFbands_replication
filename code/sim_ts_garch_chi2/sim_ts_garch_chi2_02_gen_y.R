...
# File: Simulations for time series with Chi Square GARCH errors - Draw the time series using an AR(1) process.
...
lapply(1:nrow(params), function(p){ # iterate over parameters
  ...
  # Simulation
  y_r <- replicate(R_mc, sim_ar1_y_garch_chi2(N = N, I = I, phi = phi), simplify = "array")
